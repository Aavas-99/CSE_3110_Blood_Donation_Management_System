...
<head>
  ...
  <style>
    * { font-family: 'Inter', sans-serif; }
    ...
    .input-field.error { border-color: rgba(239,68,68,0.8); }
...
<body class="auth-bg min-h-screen flex items-center justify-center px-4 relative overflow-x-hidden">
  ...
  <div class="relative z-10 w-full max-w-md card-enter">
    ...
    <div class="bg-gray-950/80 backdrop-blur-xl border border-white/8 rounded-3xl shadow-2xl overflow-hidden" id="loginCard">
      ...
      <div class="p-8 md:p-10">
        ...
        <div class="text-center mb-10">
          <div class="inline-flex flex-col items-center gap-3">
            ...
            <div>
              <h1 class="text-2xl font-bold text-white">Hospital Login</h1>
              <p class="text-gray-500 text-sm mt-1">Sign in to your BloodLink dashboard</p>
            </div>
          </div>
        </div>
        ...
        @if(session('success'))
        <div class="mb-6 px-5 py-4 bg-green-950/40 border border-green-800/50 rounded-xl text-green-400 text-sm flex items-center gap-3">
        ...
        @if(session('error'))
        <div class="mb-6 px-5 py-4 bg-red-950/50 border border-red-800/60 rounded-xl text-red-400 text-sm flex items-center gap-3" id="errorBanner">
        ...
        <div class="mb-6 px-5 py-4 bg-red-950/50 border border-red-800/60 rounded-xl text-red-400 text-sm">
          ...
          <ul class="list-disc list-inside space-y-1 text-red-400/80 mt-1">
        ...
        <form action="{{ route('hospital.login.submit') }}" method="POST" id="loginForm" class="space-y-5">
          ...
          <p class="text-center text-sm text-gray-600">
            Not registered yet?
            <a href="{{ route('hospital.register') }}" class="text-red-400 hover:text-red-300 font-medium transition-colors">
    ...
    <!-- Role switcher -->
    <div class="mt-5 bg-gray-950/60 border border-white/6 rounded-2xl p-4">
      <p class="text-center text-xs text-gray-600 mb-3">Sign in as a different role</p>
      <div class="grid grid-cols-2 gap-2">
        <a href="{{ url('/donor/login') }}"
           class="flex items-center justify-center gap-2 py-2.5 px-4 bg-gray-900/60 hover:bg-red-950/40 border border-gray-800 hover:border-red-900 rounded-xl text-xs text-gray-500 hover:text-red-400 transition-all duration-200">
          💉 Donor Login
        </a>
